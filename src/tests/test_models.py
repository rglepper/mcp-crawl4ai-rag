...
def test_temporary_analysis_request_validates_fields():
    ...
    assert request.repo_url == "https://github.com/pydantic/pydantic"
    assert request.focus_areas == ["auth", "validation"]
    assert request.include_tests is True


def test_temporary_analysis_request_has_default_values():
    """Test that TemporaryAnalysisRequest has correct default values."""
    from src.models import TemporaryAnalysisRequest
...
def test_all_models_can_be_serialized_to_json():
    ...
    models_to_test = [
        ...
        TemporaryAnalysisRequest(repo_url="https://github.com/test/repo"),
